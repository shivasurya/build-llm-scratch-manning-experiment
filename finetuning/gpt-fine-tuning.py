...
if __name__ == "__main__":
    ...
    #get user to input a noun as a string variable
        detectSpamPrompt = input("Ask a question (spam detection):")

        if detectSpamPrompt == 'quit':
            break
        else:
            print('-----------ANSWER-----------')
            print(classify_review(
                detectSpamPrompt, model, tokenizer, device, max_length=train_dataset.max_length
            ))
            print('-----------ANSWER-----------')
